...
#include "config/dashcoincoin-config.h"
#endif
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s dashcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  dashcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dashcoin transaction") + "\n" +
              "  dashcoin-tx [options] -create [commands]   " + _("Create hex-encoded dashcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded dashcoin transaction
